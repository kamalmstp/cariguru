      ...
      <div class="container-fluid p-0">
        ...
        <div class="authentication-main">
                  ...
                  <div class="card mt-4" style="border-radius: 4px;">
                    <div class="card-body">
                      <form class="theme-form" action="<?php echo site_url('login/do_login')?>" method="post">
                        ...
                        <div class="form-group">
                            <input class="form-control" placeholder="Nama Lengkap" name="nama" type="text" autofocus required="" style="background-color: #F9EFF2; border-color: #F9EFF2;">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input class="form-control" placeholder="No Hp" name="tel" type="text" autofocus required="" style="background-color: #F9EFF2; border-color: #F9EFF2;">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input class="form-control" placeholder="Ulangi Password" name="password2" type="password" autofocus required="" style="background-color: #F9EFF2; border-color: #F9EFF2;">
                        </div>
          ...
          <div class="row">
            <div class="col-md-12">
                <div class="text-center">
                  <p style="color: red;">Sudah punya akun? Silahkan <a href="<?php echo site_url('login')?>"><b style="color: red;">Masuk</b></a></p>
                </div>
            </div>
          </div>
        </div>
